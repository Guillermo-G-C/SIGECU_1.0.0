...
public class AsignaExamen {
	...
	public AsignaExamen(int idasignaExamen, String asignado, String fechaInicio, String fechaFin, String horaInicio, String horafin, String realizado, String status) {
		super();
		this.idasignaExamen = idasignaExamen;
		this.asignado = asignado;
		this.fechaInicio = fechaInicio;
